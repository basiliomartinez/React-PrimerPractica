...
const Conceptos = ({codComision, tema, version}) => {
    return (
        <section>
            ...
            <p>  Uno de los conceptos clave en React son los componentes. Un componente
        ...
        automáticamente en la interfaz de usuario.</p>
         <div className="alert alert-info" role="alert">
    Comision: {codComision} - Tema {tema} Version {version}
      </div> 
        </section>
    );
};
